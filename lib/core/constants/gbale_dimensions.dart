/// This class provides the default dimensions to be used the in GBALE app.

/// These constants can be used in place of using hardcoded heights or widths for in-app dimensioning.
/// For example, rather than declaring SizedBox(height: 16), we can declare SizedBox(height: GbaleDimensions.medium).
/// For example, rather than declaring SizedBox(width: 4), we can declare SizedBox(width: Gbaleimensions.tiny).
class GbaleDimensions {
  GbaleDimensions._();
